...
unset($doc->_scripts[$this->baseurl . '/public/font_end/bootstrap.min.js']); // Remove joomla core bootstrap
//Load Helix
    ...
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width,initial-scale=1.0">
                ...
                $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, virtuemart.css, default.css, quizzes.css,  j2store.css, jevent.css') // CSS Files
